...
import { Shield, Mail, Lock, Eye, EyeOff, Zap, Activity } from 'lucide-react';
      ...
      <div className="w-full max-w-6xl relative z-10 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="hidden md:block space-y-8 animate-fade-in-up">
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg text-slate-300 leading-relaxed">
              Professional vehicle inspection powered by artificial intelligence
            </p>
          </div>
          ...
          <div className="space-y-4">
            <FeatureCard
              ...
              description="Instant AI-powered damage detection"
            ...
            <FeatureCard
              ...
              description="Track all vehicles seamlessly"
        ...
        <div className="w-full animate-fade-in-up" style={{ animationDelay: '100ms' }}>
          ...
          <div className="md:hidden text-center mb-8">
            ...
            <p className="text-slate-400 text-sm">Driver Portal</p>
          </div>
            ...
            <div className="relative p-8 space-y-6">
              ...
              <form onSubmit={handleLogin} className="space-y-5">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link to="/driver/forgot-password" className="text-sm text-slate-300 hover:text-white transition-colors">
                    Forgot Password?
                  </Link>
                </div>
              ...
              <div className="text-center pt-2 border-t border-white/10">
                <p className="text-sm text-slate-400">
                  ...
                  <Link to="/driver/signup" className="text-white hover:underline font-medium cursor-pointer">
                    sign up here
                  </Link>
                </p>
              </div>
